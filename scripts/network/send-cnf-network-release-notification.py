...
def construct_message(release_info, prow_job_url, phase1_prow_url=None):
    ...
    if release_info.get("reportportal_url_net_core"):
        links.append(f"Report Portal: {release_info['reportportal_url_net_core']}")
...
def parse_arguments():
    ...
    parser.add_argument("--reportportal-url-net-core", default="", help="Report Portal URL for Net Core")
...
def create_release_info(args, rhel_version):
    ...
    return {
        ...
        "reportportal_url_net_core": args.reportportal_url_net_core,
        "test_env": {
