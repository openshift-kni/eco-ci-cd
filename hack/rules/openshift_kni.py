...
# This code has been imported and slightly modified from:
# https://github.com/redhatci/ansible-collection-redhatci-ocp/tree/main/hack/rules
# redhat_ci has been renamed to openshift_kni
# you can compare these as follows:
# src=https://raw.githubusercontent.com/redhatci/ansible-collection-redhatci-ocp/refs/heads/main/hack/rules/redhat_ci.py
# to compare vs main branch of src, run: ./hack/rules/diff_src.sh
...
class CollectionNamingConvention(AnsibleLintRule):
    ...
    id = "OCPKNI001"
    description = "RedHat OCP KNI custom naming conventions"
    severity = "MEDIUM"
    tags = ["experimental", "idiom", "redhat", "openshiftkni"]
    ...
    def get_var_naming_matcherror(
        ...
        return MatchError(
            tag="openshiftkni[no-role-prefix]",
